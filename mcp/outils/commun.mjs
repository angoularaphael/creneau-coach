 ...
 *  - une absence se repond « ABSENT DU CONTRAT » + valeurs valides + « demander a Eddy ».
 */
    ...
    content: [
      {
        ...
        text:
          ...
          `Ne pas inventer une valeur plausible : ouvrir la question avec Eddy, ou faire une PR sur ` +
