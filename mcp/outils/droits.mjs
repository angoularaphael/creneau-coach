        ...
        return absent(
          ...
          m.tables.map((t) => t.table),
          {
            detail:
              ...
              'politique n\'est pas encore ecrite. Ne pas la laisser ouverte : poser la question a Junior.',
          },
        )
      }
    }
      ...
      return absent(
        ...
        [],
        {
          detail:
            ...
            'Junior avant d\'etre du code. Verifier aussi la liste « Hors lot » : ' +
      ...
      return absent(
        ...
        [],
        {
          detail:
            ...
            `Un code d'erreur sans test contractuel est un trou de couverture : le signaler a Junior.`,
        },
      )
    }
