...
**Tranché par :** Eddy, 18 septembre 2026 — « go with the API contract, API book ».
...
**Tranché par :** Eddy, 18 septembre 2026 — « if a coach is suspended, then he's suspended,
...
**Source : aucune.** Ni le cahier des charges, ni `CAHIER-API.md` ne fixent de durée. Eddy,
...
**Tranché par :** Eddy, 18 septembre 2026 — le compte distant est en **Pro**.
...
Demande d'Eddy du 18 septembre 2026. D1 avait prévu sa propre sortie : « les porter vers
